    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hi! I am Juan, and I've been fortunate to wear many hats in my career. My curiosity
              has led me not only to become a licensed lawyer but also to independently build
              solutions from scratch using AI.
            </p>
